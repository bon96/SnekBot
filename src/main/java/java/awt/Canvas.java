...
import static api.MethodContext.canvas;
...
public class Canvas extends Component implements Accessible {
    ...
    //For drawing on osrs canvas.

    public static BufferedImage client = new BufferedImage(764, 503,
     ...
     */
    public Canvas() {
        System.out.println("Customized canvas intialized.");
    }
    ...
    public Graphics getGraphics() {
        if (addListener && MethodContext.mouse != null) {
            MethodContext.mouse.instance.getApplet().getComponent(0).addMouseMotionListener(MethodContext.mouse);
            MethodContext.mouse.instance.getApplet().getComponent(0).addMouseListener(MethodContext.mouse);
            addListener = false;
        }
        Graphics g = canvas.getGraphics();
        super.getGraphics().drawImage(canvas, 0, 0, null);
        return g;
    }
